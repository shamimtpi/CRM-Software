...
Invoice.prototype = {
     ...
     */
    newRow: function () {
        jQuery(".item-row:last").after('<tr class="item-row"><td class="item-name"><div class="delete-btn"><input type="text" class="form-control item" placeholder="Item Name" name="item_name[]" type="text"><a class=' + $.opt.delete.substring(1) + ' href="javascript:;" title="Remove row">X</a></div></td><td><input class="form-control price" placeholder="Price" type="number" name="item_price[]"> </td><td><input class="form-control qty" placeholder="Quantity" type="number" name="item_qty[]"></td><td><span class="total" id="itemtotal">0.00</span><input type="hidden" class="total" name="item_total[]"></td></tr>');
