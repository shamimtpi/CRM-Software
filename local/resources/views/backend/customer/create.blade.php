      ...
      <div class="right_col" role="main">
        <div class="x_panel">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="phone" value="{{old('phone')}}"  class="form-control col-md-7 col-xs-12">
              @if($errors->has('phone'))
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="passowrd" id="passowrd" name="password"  class="form-control col-md-7 col-xs-12">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="password" id="email" name="password_confirmation" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
