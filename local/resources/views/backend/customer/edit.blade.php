        ...
        <div class="x_panel">
          @if (Session('status'))
               <div class="alert alert-success text-center">
                <strong>New client added successfully</strong>
              </div>
          @endif
          ...
          <!-- confirm password -->
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="password"><span class="required">Confirm Password</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="password" id="password" name="password_confirmation" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="item form-group">
           ...
           <div class="col-md-6 col-sm-6 col-xs-12">
             <input type="file" class="col-md-10 col-sm-6 col-xs-12" name="img" value="">
             <img src="{{asset('local/public/contents/backend/')}}/images/picture.jpg" alt="profile photo" width="100" height="80">
             @if($errors->has('img'))
          ...
          <div class="item form-group">
           ...
           <div class="col-md-6 col-sm-6 col-xs-12">
             <input type="file" class="col-md-10 col-sm-6 col-xs-12" name="nid" value="">
             <img src="{{asset('local/public/contents/backend/')}}/images/picture.jpg" alt="Nif photo" width="100" height="80">
             @if($errors->has('nid'))
          ...
          <div class="item form-group">
           ...
           <div class="col-md-6 col-sm-6 col-xs-12">
             <input type="file" class="col-md-10 col-sm-6 col-xs-12" name="singature" value="">
             <img src="{{asset('local/public/contents/backend/')}}/images/picture.jpg" alt="profile photo" width="100" height="80">
